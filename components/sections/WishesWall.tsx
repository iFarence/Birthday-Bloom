...
export default function WishesWall() {
  ...
  return (
    <section ref={sectionRef} className="relative" style={{ background: 'linear-gradient(180deg, #FFF7E6 0%, #FDE8EC 50%, #E8EFF5 100%)' }}>
      <img src="/images/bg-rosewood.png" alt="" aria-hidden="true" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center', mixBlendMode: 'multiply', opacity: 0.18, pointerEvents: 'none', zIndex: 0 }} />
      <div className="py-20 px-6" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div ref={listRef} className="flex flex-col gap-3 max-h-[480px] overflow-y-auto pr-1" style={{ scrollbarWidth: 'thin', scrollbarColor: '#F7C8D3 transparent' }}>
              {wishes.length === 0 ? (
                <div className="flex flex-col items-center gap-2 py-16 text-center">
                  ...
                  <p className="font-serif italic text-midnight text-sm[5px]">Jadilah yang pertama menitipkan bunga!</p>
                </div>
              ) : (
                wishes.map((w, idx) => (
